...
**Solution** : L'utilisateur renvoye l'intégralité des échanges (COT incluses via un fichier incrémenté au format markdown .md ) à chaque itération, créant une mémoire externe dans la limite des 50Mo (au 17/06/2026).
